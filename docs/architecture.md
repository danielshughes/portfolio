...
The required quality job always reports. Recognised docs-only changes skip expensive checks and deployment; site content is code for this purpose. Pull requests have no deployment credentials.
