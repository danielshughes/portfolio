/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false worker/worker-configuration.d.ts` (hash: 5a4b6128fc09c10d670d1e12ab5fae14)
// Runtime types generated with workerd@1.20260911.1 2026-09-10 nodejs_compat
interface __BaseEnv_Env {
  RADAR_SNAPSHOTS: KVNamespace;
  HISTORY: D1Database;
  RADAR_COLLECTION_QUEUE?: Queue;
  EXPERIMENT_STARTS: RateLimit;
  RADAR_INGRESS: RateLimit;
  RADAR_UPSTREAM: RateLimit;
  AI: Ai;
  CF_VERSION_METADATA: WorkerVersionMetadata;
  ASSETS: Fetcher;
  RADAR_NATIVE_CACHE: boolean;
  ...
  COORDINATION: DurableObjectNamespace<import("./index").CoordinationRoom>;
}
declare namespace Cloudflare {
  interface GlobalProps {
    mainModule: typeof import("./index");
    durableNamespaces: "CoordinationRoom";
  }
